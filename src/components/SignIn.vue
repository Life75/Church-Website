            ...
            <span class="flex flex-col justify-center align-middle  gap-5">
                ...
                <span class="flex flex-col gap-2">
                    ...
                    <label class="input input-bordered flex items-center gap-3">
                        ...
                        <input type="text" class="grow" v-model="userCreds.username" placeholder="Username" />
                    </label>
                </span>
                ...
                <span class="flex flex-col gap-2">
                    ...
                    <label class="input input-bordered flex items-center gap-2">
                        ...
                        <input :type="isVisible ? `text` : `password`" class="grow" placeholder="Password"
                            v-model="userCreds.password" />


                        <span @click="isVisible = !isVisible">
                            <svg v-if="isVisible" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
