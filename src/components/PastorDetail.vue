<template>
     <div class="flex justify-between px-4 mx-auto max-w-screen-xl py-10">
        <article class="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
        <header class="mb-4 lg:mb-6 not-format">
              <address class="flex items-center mb-6 not-italic">
                  <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                      <img class="rounded-full mr-4 w-20 h-20 object-cover" src="./pastor.png"/>
                      <div>
                          <a href="#" rel="author" class="text-xl font-bold text-gray-900 ">Gregory Washington </a>
                          <p class="text-base font-light text-gray-500 dark:text-gray-400">Pastor, Counselor & educator</p>
                      </div>
                  </div>
              </address>
          ...
          <div class="mb-4">
            At Jesus Can Help Ministry, we understand that life's burdens can sometimes weigh heavily upon us, leaving us feeling lost, confused, or overwhelmed. That is why I am thrilled to announce the launch of our new Christianity Counseling Services, designed specifically to address the unique spiritual needs of our congregation and beyond.
          </div>
          <div class="mb-4">
            Through prayer, counseling sessions, biblical study, and intentional reflection, we strive to help you discover renewed purpose, develop healthier relationships, and cultivate a vibrant spiritual life. Our goal is to guide you towards a place of healing, wholeness, and restored joy as you journey closer to the heart of our Lord.
          </div>
          <div class="mb-4">
